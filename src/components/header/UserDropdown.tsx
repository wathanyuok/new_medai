...
export default function UserDropdown() {
  ...
  const Logout = async () => {
    const line_id = localStorage.getItem('lineId');
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://shop.api-apsx.co/crm'}/auth/logout/${line_id}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
  ...
  const userProfileDropdown = (userDataProfile: Customer | null) => {
    return (
  ...
  return userProfileDropdown(userDataProfile);
}
